...
class DatasetField(BaseModel):
    ...
    jsonPath: str = Field(..., description="JSONPath expression to access this field in a data record. Always use bracket notation with single quotes to prevent parsing errors: $['fieldname'] instead of $.fieldname. This must always end at a primitive data type.")
    type: str = Field(default="string", description="Primitive field data type: string, number, boolean, date, or datetime.")
